...
export default class Methods {
	...
	*/
	"execute" (
		...
		return queryOkJSON( this.__apiPromise, this.__nativeContract, this.__callerAddress, "execute", [req, signature], __options , (result) => { return handleReturnType(result, getTypeDescription(15, 'ink-meta-transaction')); });
	}

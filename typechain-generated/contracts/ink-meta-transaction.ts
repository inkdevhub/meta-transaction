...
import ABI from '../../artifacts/ink-meta-transaction.json';
import QueryMethods from '../query/ink-meta-transaction';
import BuildExtrinsicMethods from '../build-extrinsic/ink-meta-transaction';
import TxSignAndSendMethods from '../tx-sign-and-send/ink-meta-transaction';
import MixedMethods from '../mixed-methods/ink-meta-transaction';
import EventsClass from '../events/ink-meta-transaction';

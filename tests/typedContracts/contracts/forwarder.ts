...
import { ContractAbi } from '../contract-info/forwarder';
import QueryMethods from '../query/forwarder';
import BuildExtrinsicMethods from '../build-extrinsic/forwarder';
import TxSignAndSendMethods from '../tx-sign-and-send/forwarder';
import MixedMethods from '../mixed-methods/forwarder';
import EventsClass from '../events/forwarder';

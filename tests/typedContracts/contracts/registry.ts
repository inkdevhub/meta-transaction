...
import { ContractAbi } from '../contract-info/registry';
import QueryMethods from '../query/registry';
import BuildExtrinsicMethods from '../build-extrinsic/registry';
import TxSignAndSendMethods from '../tx-sign-and-send/registry';
import MixedMethods from '../mixed-methods/registry';
import EventsClass from '../events/registry';

import type * as EventTypes from '../event-types/forwarder';
...
export default class EventsClass {
	...
	public subscribeOnExecutedEvent(callback : (event : EventTypes.Executed) => void) {
		const callbackWrapper = (args: any[], event: any) => {
			...
			callback(handleEventReturn(_event, getEventTypeDescription('Executed', EVENT_DATA_TYPE_DESCRIPTIONS)) as EventTypes.Executed);
		};

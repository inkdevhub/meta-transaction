...
import { ContractFile } from '../contract-info/flipper';
...
export default class Constructors {
	...
	* new
	*
	* @param { ArgumentTypes.AccountId } trustedForwarder,
	* @param { boolean } initValue,
	*/
   	async "new" (
		trustedForwarder: ArgumentTypes.AccountId,
		initValue: boolean,
		...
		const storageDepositLimit = __options?.storageDepositLimit;
			const tx = code.tx["new"]!({ gasLimit, storageDepositLimit, value: __options?.value }, trustedForwarder, initValue);
			let response;
